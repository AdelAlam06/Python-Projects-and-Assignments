...
class TestLab4(unittest.TestCase):
    ...
    def test_sum_even_large(self):
        ...
        self.assertEqual(lab4_funcs.sumeven(10**6), 999999000000)

    def test_sum_squares_positive_1(self):
        # 1 + 4 + 9 + 16 + 25 = 55
        self.assertEqual(lab4_funcs.sumsquares(5), 55)
    ...
    def test_sum_squares_large_input(self):
        ...
        self.assertEqual(lab4_funcs.sumsquares(10000), 333383335000)

    def test_odddigitsum_positive_integer(self):
        self.assertEqual(lab4_funcs.odddigitsum(
            123456789), 25)  # 1 + 3 + 5 + 7 + 9 = 25

    def test_odddigitsum_negative_integer(self):
        self.assertEqual(lab4_funcs.odddigitsum(-13579),
                         25)  # 1 + 3 + 5 + 7 + 9 = 25
    ...
    def test_listexponential_negative_exponent(self):
        self.assertEqual(lab4_funcs.listexponential(3, -2),
                         [1, -2, 4])  # Negative exponent is allowed

    def test_listexponential_float_base(self):
        self.assertEqual(lab4_funcs.listexponential(
            4, 0.5), [1, 0.5, 0.25, 0.125])

    def test_listexponential_large_exponent(self):
        self.assertEqual(lab4_funcs.listexponential(6, 10),
                         [1, 10, 100, 1000, 10000, 100000])

    def test_listexponential_large_base(self):
        self.assertEqual(lab4_funcs.listexponential(5, 1000), [
    ...
    def test_listexponential_zero_base(self):
        ...
        self.assertEqual(lab4_funcs.listexponential(5, 0), [1, 0, 0, 0, 0])
    ...
    def test_stringtofloatlist_positive_integers(self):
        self.assertEqual(lab4_funcs.stringtofloatlist(
    ...
    def test_maxbytype_all_float(self):
        self.assertEqual(lab4_funcs.maxbytype(
    ...
    def test_maxbytype_mixed_types_with_non(self):
        mixed_input_with_none = list(
            range(1000)) + [3.14, 1.0, 4.2] + [None, 'banana', 'cherry']
        self.assertEqual(lab4_funcs.maxbytype(
