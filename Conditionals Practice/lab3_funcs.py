...
def inversions(items):
    ...
    if (len(items) != 3):
        ...
        return 0
    elif (items[0] >= items[1] and items[0] >= items[2] and items[1] >= items[2]):
        return 3
    elif (items[0] >= items[1] and items[0] >= items[2] or items[0] >= items[2]
          and items[1] >= items[2]):
        return 2
    elif (items[0] >= items[1] or items[1] >= items[2]):
        return 1
