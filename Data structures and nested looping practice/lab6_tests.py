...
class TestLab6(unittest.TestCase):
    ...
    def test_two_summers_5(self):
        self.assertEqual(lab6_funcs.two_summers(
            [-5, -3, -1, 0, 1, 2, 4], -4), (-5, 1))
    ...
    def test_count_dominators_5(self):
        self.assertEqual(lab6_funcs.count_dominators(
            [13, 12, 7, 6, 1, 9, 8, 4]), 5)
    ...
    def test_safe_squares_rooks_2(self):
        self.assertEqual(lab6_funcs.safe_squares_rooks(
    ...
    def test_remove_after_kth_1(self):
        self.assertEqual(lab6_funcs.remove_after_kth(
            [1, 2, 2, 3, 3, 3, 4, 4, 4, 4], 2), [1, 2, 2, 3, 3, 4, 4])
    ...
    def test_remove_after_kth_4(self):
        self.assertEqual(lab6_funcs.remove_after_kth([1, 2, 3, 4, 5, 4, 3, 2, 1, 2, 3, 4, 5, 4, 3, 2, 1, 2, 3, 4, 5], 3), [
